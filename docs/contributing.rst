...
.. _ambitioninc repository: https://github.com/ambitioninc/python-logentries-api/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/ambitioninc/python-logentries-api.git
    $ cd python-logentries-api
    $ virtualenv env
    $ . env/bin/activate
    $ pip install nose
...
.. code-block:: python
    ...
    from logentries_api.version import __version__
...
* Bump version in logentries_api/version.py
